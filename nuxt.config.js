...
const nuxtConfig = {
  ...
  head: {
    ...
    meta: [
      ...
      { name: 'title', content: `${config.name} | aspiring software engineer` },
      { name: 'author', content: config.name },
      { property: 'og:type', content: 'website'},
      { property: 'og:url', content: config.social },
      { property: 'og:title', content: `${config.name} | aspiring software engineer` },
      ...
      { property: 'twitter:title', content: `${config.name} | aspiring software engineer` },
